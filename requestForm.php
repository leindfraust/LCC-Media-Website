...
<form action="requestForm.php" method="post">
	<div class="field">
		...
		<p class="help">Input your full name (e.g. John Smith Doe) </p><br>
		<label class="label">Year/Section or Address</label>
		<div class="control">
			<input type="text" name="gradeSectionAddress" placeholder="your grade and section or address" /required>
		</div>
		<p class="help">Input your year and section (e.g. 12-ICT) </p>
		...
		<p class="help">Input your mobile number (e.g. 09888888888) </p>
