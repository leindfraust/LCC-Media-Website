<?php session_start();
 if(!isset($_SESSION['journalist'])){
    ...
    if(isset($_POST['submit'])){
        ...
        $query = "INSERT INTO news01(Author,Title, Summary, Paragraph_1, Paragraph_2, Paragraph_3, Date) VALUES('$Author','$Summary', '$Paragraph_1', '$Paragraph_2', '$Paragraph_3', '$Title', '$Date')"; 
...
<body>
    ...
    <button class="button is-danger"><a href="scripts/logoutJournal01.php">Logout</a></button>
