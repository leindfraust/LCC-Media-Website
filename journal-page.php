<?php session_start();
 if(!isset($_SESSION['journalist'])){
    ...
    if(isset($_POST['submit'])){
        ...
        $query = "INSERT INTO news01(Author, Summary, Paragraph_1, Paragraph_2, Paragraph_3, Title, Date) VALUES('$Author','$Summary', '$Paragraph_1', '$Paragraph_2', '$Paragraph_3', '$Title', '$Date')"; 
