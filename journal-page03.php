<?php session_start();
 if(!isset($_SESSION['journalist03'])){
    ...
    if(isset($_POST['submit'])){
        ...
        $query = "INSERT INTO news03(Author,Title, Summary, Paragraph_1, Paragraph_2, Paragraph_3) VALUES('$Author','$Summary', '$Paragraph_1', '$Paragraph_2', '$Paragraph_3', '$Title')"; 
...
<body>
    ...
    <buttton class="button is-danger"><a href="scripts/logoutJournal03.php">Logout</a></buttton>
</body>
